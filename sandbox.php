...
<body>
    ...
    if (!isset($_GET['objetivo'])) {
        echo '<div class="sumir bg-escuro-principal p-5 alert show">
            <div class="row">
                <div class="col">
                    <h3 class="text-center fs-1 mb-4">Selecione seu objetivo</h1>
                </div>
            </div>
            <div class="row">
                <div class="col text-center">
                    <p class="fs-5">Você realizou seu cadastro, selecione agora seu objetivo para te guiarmos melhor!</p>
                </div>
            </div>
            <div class="row">
