                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item mx-3">
                                <a href="./register.php" id="registrar"
                                    class="nav-link text-white btn btn-azul px-3">Começar Agora</a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <div id="image-switcher" class="carousel slide" data-ride="carousel" data-wrap="false" data-interval="5000">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="switcher-images" src="../main/lib/images/carousel-images/Carousel-Item-1.jpg"
                        alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="switcher-images" src="../main/lib/images/carousel-images/Carousel-Item-2.jpg"
                        alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="switcher-images" src="../main/lib/images/carousel-images/Carousel-Item-3.jpg"
                        alt="Third slide">
                </div>
                <div class="carousel-item">
                    <img class="switcher-images" src="../main/lib/images/carousel-images/Carousel-Item-4.jpg"
                        alt="Fourth slide">
                </div>
                <div class="carousel-item">
                    <img class="switcher-images" src="../main/lib/images/carousel-images/Carousel-Item-5.jpg"
                        alt="Fourth slide">
                </div>
                <div class="carousel-item">
                    <img class="switcher-images" src="../main/lib/images/carousel-images/Carousel-Item-6.jpg"
                        alt="Fourth slide">
                </div>
                <div class="carousel-item">
                    <img class="switcher-images" src="../main/lib/images/carousel-images/Carousel-Item-7.jpeg"
                        alt="Fourth slide">
                </div>
            </div>
    ...
    <div class="container-fluid background-escuro">
        <div class="row text-light d-flex justify-content-center align-items-center">
            ...
            <div class="col-md-6 d-none d-md-block" style="height: 100%;">
                <img src="../main/lib/images/section-images/Section-Image-4.png" alt="" id="imagem-comecar"
                    class="img-fluid my-5 pe-3 img-section" style="width: 100%;height: 100%;">
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4 col-12">
                    <h3 class="px-3 fs-3 my-4">
                        <?php
                            ...
                            echo 'Temos <span class="numeros fs-2" style="color:#ff9f1a !important;">'.$resultado.'</span> exercícios em nosso banco de dados';
                        ?>
                    </h3>
                </div>
                <div class="col-md-4 col-12">
    ...
    <div class="container-fluid m-0 p-5 background-escuro text-light fs-5 h-100">
        <div class="row py-5 d-flex align-items-center justify-content-center">
            <div class="col-12 col-md-6 justify-content-center align-items-center d-flex">
                <img src="../main/lib/images/section-images/Section-Image-1.png" alt="Imagem"
                    class="img-fluid img-section d-none d-md-block">
            </div>
        ...
        <div class="py-5 row mt-5 d-flex align-items-center justify-content-center">
            ...
            <div class="col-12 col-md-6 d-flex align-items-center justify-content-center">
                <img src="../main/lib/images/section-images/Section-Image-2.png" alt="Imagem"
                    class="img-fluid img-section d-none d-md-block">
            </div>
        </div>
        <div class="row py-5 mt-5 d-flex align-items-center justify-content-center">
            <div class="col-12 col-md-6 d-flex align-items-center justify-content-center">
                <img src="../main/lib/images/section-images/Section-Image-3.png" alt="Imagem"
                    class="img-fluid img-section d-none d-md-block">
            </div>
            <div class="col-12 col-md-6 col-sm-12">
