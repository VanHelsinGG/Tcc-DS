        ...
        <div class="row">
            <nav class="escuro col-md-2 m-0 col-lg-2 d-md-block text-white p-0 vh-100 sidebar fixed-top" id="navbar">
                ...
                <ul class="list-unstyled list-group h-100">
                    <li class="active my-1 option ps-2"><a href="#" class="text-white btn my-2"><i class="bi bi-house-fill me-3"></i>Inicio</a></li>
                    <li class="my-1 option ps-2"><a href="createtraining.php" class="text-white btn my-2"><i class="bi bi-fire me-3"></i>Criar Treino</a></li>
                    <li class="my-1 option ps-2"><a href="#" class="text-white btn my-2"><i class="bi bi-person-fill me-3"></i>Alunos</a></li>
                    <li class="my-1 option ps-2"><a href="#" class="text-white btn my-2"><i class="bi bi-clipboard2-data-fill me-3"></i>Relatorios</a></li>
                    <li class="my-1 option ps-2" style="border-top: 1px solid #363330;" id="user-icon"><a href="" class="text-white btn my-2"><i class="bi bi-person-circle me-3"></i>Olympia Workout</a></li>
                </ul>
            </nav>
